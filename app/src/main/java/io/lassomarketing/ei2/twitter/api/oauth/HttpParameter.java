...
public class HttpParameter implements Comparable<HttpParameter> {
    ...
    private boolean nonMultipartUpload;
    ...
    public HttpParameter(String name, byte[] nonMultiPartData, boolean isNonMultiPartUpload) {
        this.name = name;
        this.fileData = nonMultiPartData;
        this.nonMultipartUpload = isNonMultiPartUpload;
    }
    ...
    public boolean isNonMultipartUpload() {
        return nonMultipartUpload;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (value != null ? !value.equals(that.value) : that.value != null)
            return false;
        if (fileData != null ? !fileData.equals(that.fileData) : that.fileData != null)
            return false;
        if (nonMultipartUpload != that.nonMultipartUpload)
            return false;
    ...
    public static boolean containsFile(HttpParameter[] params) {
        ...
        for (HttpParameter param : params) {
            if (param.isFile() || param.getFileData() != null) {
                containsFile = true;
                break;
            }
        }
    ...
    public int hashCode() {
        ...
        result = nonMultipartUpload ? 31 * 1231 : 31 * 1237;
        return result;
    }
    ...
    @Override
    public int compareTo(HttpParameter that) {
